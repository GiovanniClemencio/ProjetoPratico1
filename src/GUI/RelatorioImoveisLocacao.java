 ...
 * @author Portu
 */
public class RelatorioImoveisLocacao extends javax.swing.JDialog {

    /**
     * Creates new form RelatorioImoveisLocacao
     */
    ...
    private void initComponents() {
        ...
        outputLocacao = new javax.swing.JTextArea();
        ...
        jLabel1.setText("Relatório Imóveis para Locação");
        ...
        outputLocacao.setColumns(20);
        outputLocacao.setRows(5);
        outputLocacao.setEnabled(false);
        jScrollPane1.setViewportView(outputLocacao);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel2.setText("Imóveis disponíveis para locação:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioImoveisLocacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RelatorioImoveisLocacao dialog = new RelatorioImoveisLocacao(new javax.swing.JDialog(), true);
    ...
    private javax.swing.JTextArea outputLocacao;
