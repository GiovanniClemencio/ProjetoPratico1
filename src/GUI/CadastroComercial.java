 ...
 * @author Portu
 */
public class CadastroComercial extends javax.swing.JDialog {

    /**
     * Creates new form CadastroComercial
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRO DE IMÓVEL COMERCIAL");
        ...
        inputImposto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inputImpostoActionPerformed(evt);
            }
        });

        jLabel19.setText("Taxa de Imposto Federal:");
    ...
    private void verificarCampos() {
        boolean todosPreenchidos
                ...
                && !inputImposto.getText().trim().isEmpty();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroComercial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroComercial dialog = new CadastroComercial(new javax.swing.JDialog(), true);
