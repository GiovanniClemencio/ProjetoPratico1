 ...
 * @author Portu
 */
public class RelatorioPredioResidencial extends javax.swing.JDialog {

    /**
     * Creates new form RelatorioPredioResidencial
     */
    ...
    private void initComponents() {
        ...
        outputPredioResidencial = new javax.swing.JTextArea();
        ...
        jLabel1.setText("Relatório Prédios Residencial");
        ...
        outputPredioResidencial.setColumns(20);
        outputPredioResidencial.setRows(5);
        outputPredioResidencial.setEnabled(false);
        jScrollPane1.setViewportView(outputPredioResidencial);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel2.setText("Prédios residenciais cadastrados:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioPredioResidencial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RelatorioPredioResidencial dialog = new RelatorioPredioResidencial(new javax.swing.JDialog(), true);
    ...
    private javax.swing.JTextArea outputPredioResidencial;
